    ...
    <div role="alert">
        ...
        <div class="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
            ...
            <div class="flex flex-row justify-between">
                <button class="bg-red-500 hover:bg-red-700 text-white py-1 px-2 m-2 rounded-full"
                        on:click={() => dispatch('continue')}>Okay
                </button>
                <button class="bg-green-500 hover:bg-green-700 text-white py-1 px-2 m-2 rounded-full"
