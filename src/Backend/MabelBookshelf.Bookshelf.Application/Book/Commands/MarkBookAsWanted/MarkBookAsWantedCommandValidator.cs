...
{
    public class MarkBookAsWantedCommandValidator : AbstractValidator<MarkBookAsWantedCommand>
    {
        public MarkBookAsWantedCommandValidator(IBookRepository repository)
        {
