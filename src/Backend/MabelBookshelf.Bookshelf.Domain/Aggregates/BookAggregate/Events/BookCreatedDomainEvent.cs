...
namespace MabelBookshelf.Bookshelf.Domain.Aggregates.BookAggregate.Events
{
    public class BookCreatedDomainEvent : DomainEvent<Guid>
    {
        ...
        public BookCreatedDomainEvent(Guid id, string title, string[] authors, string isbn, string externalId, int totalPages, long streamPosition, string ownerId, string[] categories) : base(id, streamPosition)
        {
